          ...
          <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      name="firstName"
                      defaultValue={profileData?.firstName || 'Anna'}
                      disabled={!isEditing}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="lastName"
                      defaultValue={profileData?.lastName || 'Landlord'}
                      disabled={!isEditing}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      type="tel"
                      name="phoneNumber"
                      defaultValue={profileData?.phoneNumber || '+48987654321'}
                      disabled={!isEditing}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="street"
                      defaultValue={profileData?.street || 'ul. Właściciela 5'}
                      disabled={!isEditing}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="city"
                      defaultValue={profileData?.city || 'Warszawa'}
                      disabled={!isEditing}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="zipCode"
                      defaultValue={profileData?.zipCode || '00-002'}
                      disabled={!isEditing}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                    />
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex items-center space-x-3">
                <input
                  type="tel"
                  value={profileData?.phoneNumber || '+48987654321'}
                  disabled
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <input
                type="email"
                value={profileData?.email || 'landlord@test.com'}
                disabled

                    ...
                    {getFieldVisibility('pesel', selectedCitizenship) && (
                      <div>
                        <label className='block text-sm font-medium text-gray-700 mb-2'>
                          ...
                          <div
                            className='inline-flex items-center ml-1'
                            title='Date of birth is automatically calculated from PESEL for Polish citizens.'
                          >
                            <Info className='w-4 h-4 text-gray-400' />
                          </div>
                        </label>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center'>
                    ...
                    <span className='text-gray-900'>
                      {profileData?.email || 'landlord@test.com'}
                    </span>
                  </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-blue-800 mb-4'>
                      Upgrade to a business account to manage properties under
                      your company name. This creates a professional presence
                      and automatically transfers your existing properties to

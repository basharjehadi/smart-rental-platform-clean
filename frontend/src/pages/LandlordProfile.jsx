              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900">{profileData?.email || 'landlord@test.com'}</span>
                  </div>
            ...
            <div className="card-modern p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">Business Account Upgrade</h2>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-800 mb-4">
                      Upgrade to a business account to manage properties under your company name. 
                      This creates a professional presence and automatically transfers your existing properties to the new organization.
                    </p>

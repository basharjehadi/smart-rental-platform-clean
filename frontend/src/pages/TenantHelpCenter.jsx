...
const TenantHelpCenter = () => {
  ...
  const handleSubmitTicket = () => {
    // Placeholder for ticket submission
    alert('Ticket submission feature coming soon!');
  };
  ...
  const handleFindLegalHelp = () => {
    // Placeholder for legal help finder
        ...
        <main className="flex-1 p-6">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center cursor-pointer hover:shadow-md transition-shadow" onClick={handleLiveChat}>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center cursor-pointer hover:shadow-md transition-shadow" onClick={handleCallSupport}>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center cursor-pointer hover:shadow-md transition-shadow" onClick={handleEmailSupport}>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center cursor-pointer hover:shadow-md transition-shadow" onClick={handleSubmitTicket}>

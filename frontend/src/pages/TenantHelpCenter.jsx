...
const TenantHelpCenter = () => {
  ...
  const handleFindLegalHelp = () =>
    alert('Legal help finder feature coming soon!');
    ...
    'rental-payments': [
      {
        ...
        answer:
          'You can pay your monthly rent through bank transfer, online payment, or by setting up automatic payments. Contact your landlord for the specific payment details and account information.',
      },
      {
        question: "What should I do if I can't pay rent on time?",
        answer:
          'Contact your landlord immediately to discuss payment arrangements. Most landlords are understanding if you communicate early and propose a reasonable payment plan.',
      },
      {
        question: 'Can my landlord increase the rent during my lease?',
        answer:
          'In Poland, rent increases during an active lease are generally not allowed unless specifically stated in your lease agreement. Rent can only be increased when renewing the lease.',
      },
      {
        question: 'What happens to my security deposit?',
        answer:
          'Your security deposit is held by your landlord and should be returned within 30 days after you move out, minus any deductions for damages beyond normal wear and tear.',
      },
    ],
    maintenance: [
      {
        ...
        answer:
          'Landlords are responsible for structural repairs, heating, plumbing, and electrical systems. Tenants are responsible for minor repairs and damages caused by their actions.',
      },
      {
        question: 'How do I report a maintenance issue?',
        answer:
          "Report maintenance issues to your landlord in writing (email or text) with photos if possible. Keep records of all communications and follow up if the issue isn't addressed promptly.",
      },
      {
        question: "What if my landlord doesn't fix important issues?",
        answer:
          "If your landlord doesn't address critical issues (heating, plumbing, electrical), you may be able to withhold rent or have repairs done and deduct the cost from your rent. Consult legal advice first.",
      },
      {
        question: 'Can I make improvements to the property?',
        answer:
          'You can make minor improvements with landlord permission. Major changes require written consent. Always get approval in writing before making any modifications.',
      },
    ],
    'legal-rights': [
      {
        ...
        answer:
          'You have the right to peaceful enjoyment of the property, privacy, reasonable notice for visits, habitable living conditions, and protection from discrimination.',
      },
      {
        question: 'How much notice is required for lease termination?',
        answer:
          'Standard notice period is 3 months for both tenant and landlord. Check your lease agreement for specific terms, as they may vary.',
      },
      {
        question: 'Can my landlord evict me without cause?',
        answer:
          'No, landlords cannot evict tenants without a valid reason. Valid reasons include non-payment of rent, lease violations, or the landlord needing the property for personal use.',
      },
      {
        question: 'What should I do if I have a dispute with my landlord?',
        answer:
          'First, try to resolve the issue through direct communication. If that fails, consider mediation services or consult with a tenant rights organization for legal advice.',
      },
    ],
  };
          ...
          <div className='max-w-6xl mx-auto space-y-6'>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600 mb-6'>
                Find answers to common questions, get support, and learn about
                your rights as a tenant in Poland.
              </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
              <div
                className='bg-white rounded-xl border border-gray-200 p-6 text-center cursor-pointer hover:bg-gray-50 transition-colors'
              ...
              <div className='p-6'>
                ...
                {activeTab === 'faq' && (
                  <div>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Find answers to common tenant questions
                    </p>
                ...
                {activeTab === 'guides' && (
                  <div>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Helpful guides for your rental journey
                    </p>
                          ...
                          <ul className='space-y-2 mb-4'>
                            {guide.points.map((point, pointIndex) => (
                              <li key={pointIndex} className='flex items-start'>
                                <span
                                  className={`inline-block w-2 h-2 rounded-full mt-2 mr-3 bg-${guide.color}-500`}
                                ></span>
                ...
                {activeTab === 'legal-info' && (
                  <div>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Know your rights and protections under Polish law
                    </p>
                    ...
                    <div className='mt-8'>
                      ...
                      <div className='bg-gray-50 rounded-lg p-6'>
                        <p className='text-gray-700 mb-4'>
                          Many cities in Poland offer free legal advice for
                          tenants.
                        </p>
                        <p className='text-gray-700 mb-4'>
                          Connect with local tenant advocacy groups for support.
                        </p>
                        <button
                    ...
                    <div className='mb-8'>
                      ...
                      <div className='bg-red-50 border border-red-200 rounded-lg p-6'>
                        ...
                        <p className='text-red-800 mt-4 font-medium'>
                          After ensuring safety, contact your landlord
                          immediately about any emergency repairs needed.
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className='bg-gray-100 rounded-lg p-6 text-center'>
                        ...
                        <p className='text-gray-600 mb-4'>
                          Available 24/7 for urgent tenant issues
                        </p>
                        <button

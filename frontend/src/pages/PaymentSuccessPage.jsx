...
const PaymentSuccessPage = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔍 handleMessageLandlord function exists:', typeof handleMessageLandlord);
  ...
  if (location.state?.paymentType === 'deposit_and_first_month') {
    ...
    const moveInDate = rentalRequest?.moveInDate ? formatDate(rentalRequest.moveInDate) : 'N/A';
    ...
    const propertyType = propertyInfo?.type ? `${propertyInfo.type}, ${propertyInfo.rooms || 'N/A'} rooms` : 'Property';
      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-3">Payment Successful!</h1>
            <p className="text-xl text-gray-600">
              Your rental is confirmed and fully protected by our safety guarantee
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <h2 className="text-xl font-bold text-green-800 mb-4">Your Payment is Protected in Escrow</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-700">Funds secured in escrow</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
                    <span className="text-green-700">Full refund if property differs</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
                    <span className="text-green-700">24-hour protection window</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Landlord Notified</p>
                      <p className="text-gray-600">{landlordName} has been notified of your payment and will prepare for your move-in on {moveInDate}.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Check in on {moveInDate}. Inspect the property carefully and compare it to the photos and description.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 font-bold">3</div>
                    <div>
                      <p className="font-medium text-gray-900">24-Hour Protection Window</p>
                      <p className="text-gray-600">After check-in, you have 24 hours to report any issues. If everything is perfect, payment is automatically released.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-yellow-800">Important: Your 24-Hour Protection</h3>
                    <p className="text-yellow-700">What to Check on Move-in Day:</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">Property matches photos and description</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">All advertised amenities are present and working</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">Property is clean and in good condition</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">Location and accessibility as described</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">Keys and access codes work properly</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-sm">Any furnishing matches what was promised</span>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              {/* Confirmed Rental */}
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <h3 className="text-lg font-bold text-green-800 mb-2">Confirmed Rental</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  {landlordInfo?.profileImage ? (
                    ...
                    <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center border-2 border-blue-200">
                      <span className="text-lg font-semibold text-blue-600">
                        {landlordName?.split(' ').map(n => n[0]).join('') || 'L'}
                      </span>
                    </div>
                  )}
                  <div>
                    <div className="font-semibold text-gray-900">{landlordName}</div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span>
                      {!propertyInfo?.id || !landlordInfo?.id ? 'Loading...' : 'Message'}
                    </span>
                  </button>
                  <button

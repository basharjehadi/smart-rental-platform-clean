...
import { CheckCircle, CreditCard, Building, Shield, Loader } from 'lucide-react';
...
const MockPaymentPage = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔍 MockPaymentPage useEffect - selectedPayments:', selectedPaymentsStr);
  ...
  const testBackendCall = async () => {
    ...
    try {
      const response = await api.post('/payments/complete-mock-payment', {
        ...
        purpose: 'MONTHLY_RENT',
        offerId: searchParams.get('offerId'),
        selectedPayments: JSON.parse(searchParams.get('selectedPayments') || '[]')
      });
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4 text-center">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-green-800">
            Your monthly rent payment has been confirmed and will be processed within 24 hours.
          </p>
        </div>

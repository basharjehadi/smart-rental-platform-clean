      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-gray-600'>
            View and manage your rent payment history for all your rental
            properties.
          </p>
        </div>
        ...
        {/* Refresh Button */}
        <div className='mb-6'>
          <button onClick={fetchRentPayments} className='btn-primary px-4 py-2'>
            Refresh Payments
          </button>
        </div>
        ...
        {rentData.length === 0 ? (
          <div className='text-center py-12'>
            <div className='text-gray-500 text-lg'>No rent payments found.</div>
            <p className='text-gray-400 mt-2'>
              You'll see rent payments here once you have accepted offers and
              leases have started.
            </p>
          </div>
        ) : (
                  ...
                  {rental.rentalRequest.isLocked && (
                    <div className='mt-3 p-3 bg-red-50 border border-red-200 rounded-md'>
                      <p className='text-sm text-red-800'>
                        ⚠️ This rental is locked due to overdue rent payments.
                        Please contact your landlord to resolve this issue.
                      </p>
                    </div>
                  )}
                </div>

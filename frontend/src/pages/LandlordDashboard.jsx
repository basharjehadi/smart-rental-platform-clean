    ...
    return (
      <div className='card-modern p-6'>
        <div className='flex items-center'>
          <div
            className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4 ${colorClasses[color]}`}
          >
    ...
    <div className='card-modern p-6'>
      ...
      <div className='space-y-3 mb-4'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <span className='font-semibold text-gray-900'>
            {dashboardData?.occupiedUnits || 0}
          </span>
        </div>
        <div className='flex justify-between items-center'>
          <span className='text-gray-600'>Vacant Units</span>
          <span className='font-semibold text-orange-600'>
            {dashboardData?.vacantUnits || 0}
          </span>
        </div>
      </div>
        ...
        dashboardData.recentTenants.length > 0 ? (
          ...
          <div className='text-center py-4'>
            <p className='text-sm text-gray-500'>
              No tenants yet. Start by creating offers!
            </p>
          </div>
        )}
      </div>
    ...
    <div className='card-modern p-6'>
      <div className='mb-4'>
        ...
        <p className='text-sm text-gray-600'>
          Your recent payments (rent + deposits)
        </p>
      </div>

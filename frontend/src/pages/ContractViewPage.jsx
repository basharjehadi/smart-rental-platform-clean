...
import { ArrowLeft, Download, FileText, User, Building, Calendar, DollarSign } from 'lucide-react';
...
const ContractViewPage = () => {
  ...
  const handleDownloadContract = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', `rental-contract-${contract.contractNumber}.pdf`);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'Contract details not available'}</p>
          <button
            onClick={() => navigate(-1)}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    ...
                    contract.status === 'GENERATED' ? 'bg-blue-100 text-blue-800' :
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{formatDate(contract.signedAt)}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="p-4 bg-blue-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-blue-900">Contract Number</h3>
                      <p className="text-sm text-blue-700">{contract.contractNumber}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">{formatDate(contract.createdAt)}</span>
                </div>
                {contract.signedAt && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Signed</span>
                    <span className="text-sm font-medium text-gray-900">{formatDate(contract.signedAt)}</span>
                  </div>
                )}
              </div>
            </div>

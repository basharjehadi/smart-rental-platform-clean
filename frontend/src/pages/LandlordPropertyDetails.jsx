...
const LandlordPropertyDetails = () => {
  ...
  const isPropertyLocked = property => {
    return property && ['RENTED'].includes(property.status);
  };
            ...
            <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6'>
              <div className='flex-1'>
                <div className='flex items-center space-x-3 mb-2'>
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(property.status)}`}
                  >
              ...
              <div className='flex items-center space-x-4 mt-4 lg:mt-0'>
                <div className='text-right'>
                  ...
                  <p className='text-3xl font-bold text-gray-900'>
                    {property.monthlyRent} zł
                  </p>
                </div>
                <button
                  onClick={() =>
                    navigate(`/landlord-edit-property/${propertyId}`)
                  }
                ...
                {isPropertyLocked(property) && (
                  <div className='mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
                    <p className='text-sm text-yellow-700 flex items-center'>
                      ...
                      This property is {property.status.toLowerCase()}. Editing
                      is disabled to protect tenant data and rental agreements.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className='bg-white rounded-2xl shadow-lg border border-gray-200 p-6'>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${property.furnished ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}
                    >
                  ...
                  <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${property.parking ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}
                    >
                  ...
                  <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${property.petsAllowed ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}
                    >
                  ...
                  <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${property.smokingAllowed ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}
                    >
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg'>
                    ...
                    <span className='text-lg font-bold text-green-600'>
                      {property.currentTenants || 0}/{property.maxTenants || 1}
                    </span>
                  </div>

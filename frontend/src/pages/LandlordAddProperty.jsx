            ...
            <div className='card-modern p-6 mb-6'>
              <div className='flex items-center justify-between mb-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Create an attractive listing to find quality tenants faster.
                  </p>
                </div>
                <button
              ...
              <div className='mb-6'>
                ...
                <div className='flex justify-between mt-4'>
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                    >
                      {currentStep > 1 ? (
                        <svg
                          className='w-4 h-4'
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${currentStep >= 2 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                    >
                      {currentStep > 2 ? (
                        <svg
                          className='w-4 h-4'
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${currentStep >= 3 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                    >
                      <svg
                        className='w-4 h-4'
                        fill='none'

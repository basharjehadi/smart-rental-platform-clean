      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            This demo shows how to use the PaymentForm component with different configurations.
          </p>
        </div>
          ...
          <div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              ...
              <p className="text-yellow-700">
                Payment form is temporarily disabled for debugging. The rest of the page should be visible.
              </p>
            </div>
            {/* <PaymentForm
              amount={amount}
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><strong>amount</strong> (number): Payment amount in PLN</li>
                <li><strong>rentalRequestId</strong> (string): ID of the rental request</li>
                <li><strong>purpose</strong> (string): "deposit" or "rent"</li>
                <li><strong>onSuccess</strong> (function): Callback when payment succeeds</li>
                <li><strong>onError</strong> (function): Callback when payment fails</li>
              </ul>
            </div>

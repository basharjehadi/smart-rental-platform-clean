  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Get help and support for your rental properties</p>
      </div>
      ...
      <div className="mt-8 bg-white rounded-lg shadow-md border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-gray-900 mb-2">How do I add a new property?</h3>
            <p className="text-gray-600">Go to your dashboard and click "Add Property" to list a new rental property.</p>
          </div>
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-gray-900 mb-2">How do I manage rental requests?</h3>
            <p className="text-gray-600">View and respond to rental requests in the "Rental Requests" section of your dashboard.</p>
          </div>
          <div className="border-b border-gray-200 pb-4">
            <h3 className="font-medium text-gray-900 mb-2">What are the fees for listing properties?</h3>
            <p className="text-gray-600">We charge a small percentage fee only when a property is successfully rented.</p>
          </div>
          <div className="pb-4">
            <h3 className="font-medium text-gray-900 mb-2">How do I update property information?</h3>
            <p className="text-gray-600">Go to "My Properties" and click the edit button on any property to update details.</p>
          </div>
        </div>
      </div>

...
const MessagingPage = () => {
  ...
  useEffect(() => {
    ...
    if (conversationId && conversationId !== 'new') {
      console.log(
        '✅ Setting selected conversation from route param:',
        conversationId
      );
      ...
      console.log(
        '✅ Setting selected conversation from query param:',
        conversationIdParam
      );
      ...
      (async () => {
        try {
          ...
          console.log(
            '🔧 Creating/finding conversation by property (once):',
            propertyId
          );
          const res = await api.post(
            `/messaging/conversations/by-property/${propertyId}`
          );

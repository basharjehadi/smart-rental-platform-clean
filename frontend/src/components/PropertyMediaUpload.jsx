...
const PropertyMediaUpload = () => {
  ...
  const handleAutoFillToggle = async () => {
    try {
      ...
      setSuccess(
        `Auto-fill media ${newValue ? 'enabled' : 'disabled'} successfully!`
      );
        ...
        <div className='bg-white rounded-xl shadow-lg p-6'>
          ...
          <div className='mt-8 p-4 bg-blue-50 rounded-lg'>
            ...
            <ul className='text-sm text-blue-800 space-y-1'>
              ...
              <li>
                • View all your uploaded media in the Media Library section
                below
              </li>
              <li>• Hover over media items to see the delete button (×)</li>
              <li>
                • Enable auto-fill to automatically include media in your offers
              </li>
              <li>• You can select which media to include in each offer</li>
              <li>
                • Supported formats: JPG, PNG for images; MP4, MOV for videos
              </li>

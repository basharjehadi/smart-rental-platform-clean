...
const RatingDisplay = ({ 
        ...
        {showStars && (
          <div className="flex items-center space-x-1">
            <Shield className={`${currentSize.star} text-blue-600`} />
                           ...
                           <div className={`inline-flex items-center px-2 py-1 rounded-full bg-blue-100 text-blue-800 font-medium ${currentSize.badge}`}>
  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      {showStars && (
        <div className="flex items-center space-x-1">
          <Star className={`${currentSize.star} text-yellow-400 fill-current`} />

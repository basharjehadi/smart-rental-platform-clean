...
const TenantReviewForm = ({ onSubmit, onClose, reviewData = null }) => {
  ...
  const criteria = [
    {
      key: 'accuracy',
      label: t('review.forms.tenantToLandlord.accuracy'),
      description: t('review.forms.tenantToLandlord.accuracyDesc'),
    },
    {
      key: 'cleanliness',
      label: t('review.forms.tenantToLandlord.cleanliness'),
      description: t('review.forms.tenantToLandlord.cleanlinessDesc'),
    },
    {
      key: 'responsiveness',
      label: t('review.forms.tenantToLandlord.responsiveness'),
      description: t('review.forms.tenantToLandlord.responsivenessDesc'),
    },
    {
      key: 'contractFairness',
      label: t('review.forms.tenantToLandlord.contractFairness'),
      description: t('review.forms.tenantToLandlord.contractFairnessDesc'),
    },
    {
      key: 'value',
      label: t('review.forms.tenantToLandlord.value'),
      description: t('review.forms.tenantToLandlord.valueDesc'),
    },
    {
      key: 'overall',
      label: t('review.forms.tenantToLandlord.overall'),
      description: t('review.forms.tenantToLandlord.overallDesc'),
    },
  ];
      ...
      <div className='bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto'>
        ...
        <div className='flex items-center justify-between p-6 border-b border-gray-200'>
          <h2 className='text-xl font-semibold text-gray-900'>
            {t('review.forms.tenantToLandlord.title')}
          </h2>
          <button
            onClick={onClose}

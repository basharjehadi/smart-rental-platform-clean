...
const LandlordReviewForm = ({ onSubmit, onClose, reviewData = null }) => {
  ...
  const criteria = [
    { key: 'onTime', label: t('review.forms.landlordToTenant.onTime'), description: t('review.forms.landlordToTenant.onTimeDesc') },
    { key: 'care', label: t('review.forms.landlordToTenant.care'), description: t('review.forms.landlordToTenant.careDesc') },
    { key: 'communication', label: t('review.forms.landlordToTenant.communication'), description: t('review.forms.landlordToTenant.communicationDesc') },
    { key: 'moveOut', label: t('review.forms.landlordToTenant.moveOut'), description: t('review.forms.landlordToTenant.moveOutDesc') },
    { key: 'overall', label: t('review.forms.landlordToTenant.overall'), description: t('review.forms.landlordToTenant.overallDesc') }
  ];
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">{t('review.forms.landlordToTenant.title')}</h2>
          <button
            onClick={onClose}

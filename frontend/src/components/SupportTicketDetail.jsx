...
import { X, Send, Clock, AlertCircle, CheckCircle, XCircle, User, Bot, ArrowLeft } from 'lucide-react';
...
const SupportTicketDetail = ({ ticket, isOpen, onClose, onBack }) => {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      setSending(true);
      const response = await api.post(`/support/tickets/${ticket.id}/messages`, {
        ...
        <div className="p-4 border-b border-gray-200 bg-gray-50">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 text-gray-900">{ticket.category.replace('_', ' ')}</span>
            </div>
            <div>

...
const UserIdentityForm = ({ onComplete, onCancel, className = '' }) => {
  ...
  const renderTenantFields = () => (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="kartaPobytu" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          {currentStep === 2 && (
            <>
              <SignatureCanvasComponent
                ...
                initialSignature={signatureBase64 ? `data:image/png;base64,${signatureBase64}` : null}
              />

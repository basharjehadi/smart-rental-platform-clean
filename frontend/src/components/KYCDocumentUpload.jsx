        ...
        <div className='flex items-start'>
          ...
          <div>
            <h4 className='text-blue-900 font-medium mb-2'>
              Why do we need your identity document?
            </h4>
            <ul className='text-blue-800 text-sm space-y-1'>
              <li>
                • KYC Verification: To verify your identity and ensure platform
                security
              </li>
              <li>
                • Contract Signing: Required for digital signature verification
                on rental contracts
              </li>
              <li>
                • Legal Compliance: Ensures all rental agreements are legally
                binding
              </li>
              <li>
                • Fraud Prevention: Protects both tenants and landlords from
                identity fraud
              </li>
            </ul>
          </div>

        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div>
            ...
            <p className='mt-1 text-sm text-gray-500'>
              When is this property available for tenants to move in?
            </p>
          </div>
          ...
          <div className='flex items-center'>
            <input
              ...
              onChange={e =>
                onInputChange('parkingAvailable', e.target.checked)
              }
      ...
      <div className='mb-8'>
        ...
        <div className='space-y-6'>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3'>
              {suggestedAmenities
                .filter(amenity => amenity.startsWith('Near '))
                .map(amenity => (
                  <button
                    key={amenity}
                    type='button'
        ...
        <div className='mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
          <p className='text-sm text-blue-700'>
            <strong>Tip:</strong> Select amenities that accurately describe your
            property. This helps tenants find properties that match their needs
            and can increase your property's visibility.
          </p>
        </div>
      </div>
    </div>

...
const SidebarItem = ({
  ...
  return (
    ...
    >
      <Icon
        className={`${isCollapsed ? 'w-5 h-5' : 'w-4 h-4 mr-3'} transition-colors duration-200`}
      />
...
const TenantSidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: 'My Requests',
      badge:
        (rentalRequestsUnread || counts.rentalRequests) > 0
          ? rentalRequestsUnread || counts.rentalRequests
          : null,
    },
    {
      to: '/my-offers',
      ...
      label: 'View Offers',
      badge:
        (offersUnread || counts.offers) > 0
          ? offersUnread || counts.offers
          : null,
    },
    {
      to: '/messaging',
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-b border-gray-100 ${isCollapsed ? 'p-4' : 'p-6'}`}
      >
      ...
      {/* Footer */}
      <div
        className={`border-t border-gray-100 ${isCollapsed ? 'p-4' : 'p-4'}`}
      >
        {!isCollapsed && (

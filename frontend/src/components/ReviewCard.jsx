  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">{isLandlord ? "Tenant Reviews" : "Landlord Reviews"}</h3>
        <button
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className={`text-sm font-medium ${pendingReviews.length > 0 ? 'text-red-600' : 'text-green-600'}`}>
              {pendingReviews.length > 0 ? `${pendingReviews.length} pending` : 'All caught up'}
            </span>
          </div>
        </div>
      </div>
      ...
      {/* View Full Review System Button */}
             ...
             >
               {isLandlord ? "View Full Tenant Review System" : "View Full Landlord Review System"}
             </button>
    </div>
  );
};

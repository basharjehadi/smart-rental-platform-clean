...
const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {messages.length} message{messages.length !== 1 ? 's' : ''} • Active now
              </p>
            </div>
          </div>
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4" style={{ maxHeight: 'calc(100vh - 280px)' }} ref={messagesContainerRef}>
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            ...
            <p className="text-center text-lg font-medium mb-2">{conversationTitle === 'Select a conversation' ? 'Select a conversation to start chatting' : 'No messages yet'}</p>

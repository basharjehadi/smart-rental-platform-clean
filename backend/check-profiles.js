...
async function checkProfiles() {
  try {
    ...
    console.log('Address:', tenant.street && tenant.city ? `${tenant.street}, ${tenant.city} ${tenant.zipCode}, ${tenant.country}` : 'Not provided');
    ...
    console.log('Address:', landlord.street && landlord.city ? `${landlord.street}, ${landlord.city} ${landlord.zipCode}, ${landlord.country}` : 'Not provided');
    ...
    if (tenant.signatureBase64) {
      console.log('\n📏 Tenant Signature Length:', tenant.signatureBase64.length);
    }
    if (landlord.signatureBase64) {
      console.log('📏 Landlord Signature Length:', landlord.signatureBase64.length);
    }

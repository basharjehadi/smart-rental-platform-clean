...
async function deleteTenantData() {
  console.log('🗑️ Deleting all rental requests and offers for tenant@test.com...');
  ...
  try {
    ...
    console.log('');
    console.log('🔗 Now when you login as tenant@test.com, you should see the empty state in the dashboard!');

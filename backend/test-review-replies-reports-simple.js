...
async function testSchemaValidation() {
  ...
  try {
    ...
    console.log('✅ Schema validation passed - ReviewReply model is accessible');
    
    // Test if we can create a ReviewReport (this will fail if schema is wrong)
    console.log('✅ Schema validation passed - ReviewReport model is accessible');
...
async function runAllTests() {
  try {
    ...
    console.log(`  Schema Validation: ${schemaTest ? '✅ PASSED' : '❌ FAILED'}`);

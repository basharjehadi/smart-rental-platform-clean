...
import requestPoolService, { trustLevelWeight } from '../../src/services/requestPoolService.js';
...
describe('RequestPoolService - New Scoring System', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    getUserTrustLevel = require('../../src/services/trustLevels.js').getUserTrustLevel;

    ...
    const reviewData = [
      {
        rating: 5,
        comment:
          'Excellent landlord! Very responsive to maintenance requests and professional communication.',
      ...
      },
      {
        rating: 4,
        comment:
          'Great property management. Only minor delay with heating repair, but overall satisfied.',
      ...
      },
      {
        rating: 5,
        comment:
          'Professional and fair landlord. Property is well-maintained and location is perfect.',

  ...
  try {
    ...
    if (typeof requestPoolService.getRequestsForLandlordUser === 'function') {
      ...
      if (requests.requests.length > 0) {
        ...
        const hasPhone =
          request.rentalRequest.tenant?.phoneNumber !== undefined;
      ...
      console.log(
        'Available methods:',
        Object.getOwnPropertyNames(Object.getPrototypeOf(requestPoolService))
      );
    }
    ...
    if (typeof requestPoolService.markAsViewedForOrg === 'function') {
      ...
      const viewCountIncrement =
        (requestAfterSecond.viewCount || 0) -
        (requestAfterFirst.viewCount || 0);
      console.log(

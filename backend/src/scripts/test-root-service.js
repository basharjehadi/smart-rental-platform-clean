...
const methodNames = Object.getOwnPropertyNames(
  Object.getPrototypeOf(requestPoolService)
);
console.log('\n📋 Available methods:');
...
console.log(
  ...
  typeof requestPoolService.findMatchingOrganizationsByProperties
);
console.log(
  'getRequestsForLandlordUser:',
  typeof requestPoolService.getRequestsForLandlordUser
);
console.log(
  'markAsViewedForOrg:',
  typeof requestPoolService.markAsViewedForOrg
);
console.log('createMatches:', typeof requestPoolService.createMatches);
console.log(
  'findBestMatchingProperty:',
  typeof requestPoolService.findBestMatchingProperty
);

  ...
  try {
    ...
    const rentalRequest = await prisma.rentalRequest.create({
      data: {
        ...
        location:
          'ul. Krakowskie Przedmieście 15/17, Śródmieście, Warszawa 00-071',
        bedrooms: 2,
        bathrooms: 1,
        budget: 3200,
        moveInDate: new Date('2024-01-15'),
        description:
          'Looking for a modern 2-bedroom apartment in the city center',
        status: 'ACTIVE',
      },
    });
    ...
    console.log('');
    console.log(
      '🔗 Now login as tenant@test.com to see real data in the dashboard!'
    );
  } catch (error) {

...
const emailTemplates = {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Great news! Your identity verification has been successfully completed and approved by our team.</p>
          
          <h3>What this means:</h3>
          <ul>
            <li>✅ Your account is now fully verified</li>
            <li>✅ You can access all platform features</li>
            <li>✅ You can participate in rental transactions</li>
            <li>✅ Your profile shows a verified badge</li>
          </ul>
          
          <p>You can now continue using the Smart Rental System with full access to all features.</p>
  ...
  kycRejection: (userName, rejectionReason) => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
      ...
      <style>
        ...
        .content { padding: 20px; background-color: #f9f9f9; }
        .footer { text-align: center; padding: 20px; color: #666; font-size: 12px; }
        .warning { background-color: #FEE2E2; border: 1px solid #EF4444; padding: 15px; border-radius: 5px; margin: 15px 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="warning">
            <strong>⚠️ Your KYC verification requires attention</strong>
          </div>
          
          <p>We've reviewed your identity verification documents and found some issues that need to be addressed.</p>
          ...
          <ul>
            ...
            <li>📤 Upload new or corrected documents</li>
            <li>🔄 Resubmit your KYC application</li>
            <li>⏳ Wait for our team to review again</li>
          </ul>
          
          <p>Please log in to your account and update your identity documents accordingly.</p>
          ...
          <p>If you have any questions about the rejection reason or need assistance, please contact our support team.</p>
...
// 🚀 SCALABILITY: KYC Approval Email
const sendKYCApprovalEmail = async (userEmail, userName) => {
  const subject = 'KYC Verification Approved - Smart Rental System';
  const htmlContent = emailTemplates.kycApproval(userName);
  return await sendEmail(userEmail, subject, htmlContent);
};

// 🚀 SCALABILITY: KYC Rejection Email
const sendKYCRejectionEmail = async (userEmail, userName, rejectionReason) => {
  const subject = 'KYC Verification Update - Smart Rental System';
  const htmlContent = emailTemplates.kycRejection(userName, rejectionReason);
  return await sendEmail(userEmail, subject, htmlContent);
};

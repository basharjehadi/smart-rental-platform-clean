...
async function debugAPI() {
  try {
    ...
    try {
      ...
      console.log('❌ GET /api/tenant-dashboard/dashboard failed:', error.response?.status, error.response?.data);
    }
    ...
    try {
      ...
      console.log('❌ GET /api/tenant-dashboard/dashboard failed without auth:', error.response?.status, error.response?.data);
    }
    ...
    try {
      ...
      console.log('❌ Dashboard endpoint failed with auth:', error.response?.status, error.response?.data);
    }
